...
namespace AirportIQ.Data
{
	...
	{
		void SaveDivision(int divisionId, int companyId, string divisionCode, string divisionName, Int16 divisionTypeId, string divisionStatusCode,
		...
		DataSet loadCompanyReviewDivisionList(Int32? CompanyID, Int32? DivisionID, String CompanyCriteria, String DivisionCriteria, Int32 UserId); // to load a list of companies

		DataSet loadCompanyReviewDivisionList(Int32? CompanyID, Int32? DivisionID, String CompanyCriteria, String DivisionCriteria, String EmployeeLNCriteria, Int32 UserId); // to load a list of companies

		DataSet loadCompanyReviewDivisionList(Int32? CompanyID, Int32? DivisionID, String CompanyCriteria, String DivisionCriteria, String EmployeeLNCriteria, String EmployeeFNCriteria, Int32 UserId); // to load a list of companies

        DataTable LoadCompanyOrDivisionContactsForm(Int32 CompanyID, Int32 DivisionID, int UserID, bool shadowMode, bool? isNewDivisionOnly); // to load Contacts data
		...
		DataTable ShadowLoadUniqueCompanyOrDivisionContactsForm(Int32 CompanyID, Int32 DivisionID, int UserID); // to load Contacts data
		DataTable LoadUniqueCompanyOrDivisionContactsForm(Int32 CompanyID, Int32 DivisionID, int UserID); // to load Contacts data
