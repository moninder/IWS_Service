...
/*
Derived from MSDN Magazine article from an article written by James McCaffrey.
 * 
 * http://msdn.microsoft.com/en-us/magazine/cc164055.aspx
 * 
 * 
*/
public class AesHelper  // Advanced Encryption Standard
{
    ...
    public AesHelper(KeySize keySize, string s)
    {
    ...
    public void Cipher(string s, byte[] output)  // encipher 16-bit input
    {
        // state = input
    ...
    public void InvCipher(string s, byte[] output)  // decipher 16-bit input
    {
        // state = input
        byte[] input = Encoding.UTF8.GetBytes(s);
        this.State = new byte[4, Nb];  // always [4,4]
