...
namespace ISBLibTest
{
  class ISBLibExtGCR
  {
    ...
    {
      // set the urls
      _docMgr.URL = @"http://" + ip + ":8080/DocumentManagerEJB/DocumentManagerBeanService/DocumentManagerBean";
	  _IDMS.URL = @"http://" + ip + ":8080/IdentityManagerEJB/IdentityManagerBeanService/IdentityManagerBean";
    }
